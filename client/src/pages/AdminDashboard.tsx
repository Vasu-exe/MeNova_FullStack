          ...
          <div className="flex items-center gap-3">
            ...
            >
              <RefreshCw
                ...
                style={{ color: "oklch(0.50 0.005 65)" }}
              />
            </button>
            <button
          ...
          {tabs.map((tab) => (
            <button
              ...
              style={{
                fontFamily: "'DM Sans', sans-serif",
                backgroundColor:
                  activeTab === tab.id ? "oklch(0.24 0.07 155)" : "white",
              ...
              {[
                {
                  ...
                  value: stats.totalQuizSubmissions,
                  sub: `${stats.quizThisWeek} this week`,
                  color: "oklch(0.24 0.07 155)",
                },
                {
                  label: "Follow-up Requests",
                  value: stats.totalFollowUpRequests,
                  sub: `${stats.followUpQualified} qualified`,
            ...
            <div className="grid lg:grid-cols-2 gap-6 mb-8">
              ...
              >
                ...
                {(stats?.tierBreakdown
                  ? [
                      {
                        label: "Early Stage",
                        count: stats.tierBreakdown.earlyStage,
                        color: "oklch(0.55 0.06 155)",
                      },
                      {
                        label: "Moderate Symptoms",
                        count: stats.tierBreakdown.moderate,
                        color: "oklch(0.60 0.12 42)",
                      },
                      {
                        label: "Significant Symptoms",
                        count: stats.tierBreakdown.significant,
                        color: "oklch(0.24 0.07 155)",
                      },
                    ]
                  : []
                  ...
                  return (
                    <div key={tier.label} className="mb-3">
                      ...
                      >
                        <span style={{ color: "oklch(0.35 0.005 65)" }}>
                          {tier.label}
                        </span>
                        <span style={{ color: "oklch(0.50 0.005 65)" }}>
                          {tier.count} ({pct}%)
                        </span>
                      </div>
                      <div
                        className="w-full h-2 rounded-full"
                        style={{ backgroundColor: "oklch(0.92 0.01 90)" }}
                      >
                        <div
              ...
              >
                ...
                Object.entries(stats.utmSources).length > 0 ? (
                  Object.entries(stats.utmSources)
                    ...
                    .map(([source, count]) => (
                      <div
                        ...
                        style={{ borderColor: "oklch(0.92 0.01 90)" }}
                      >
                        <span
                  ...
                  >
                    No traffic source data yet. Sources will appear as quiz
                    submissions come in.
                  </p>
                )}
              </div>
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  {
                    label: "Pending",
                    count: stats.followUpPending,
                    color: "oklch(0.60 0.12 42)",
                  },
                  {
                    label: "Qualified",
                    count: stats.followUpQualified,
                    color: "oklch(0.24 0.07 155)",
                  },
                  {
                    label: "Not Qualified",
                    count:
                      stats.totalFollowUpRequests -
                      stats.followUpQualified -
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <div className="relative flex-1">
                <Search
                  ...
                  style={{ color: "oklch(0.55 0.005 65)" }}
                />
                <input
                  type="text"
                    ...
                    <thead>
                      <tr style={{ backgroundColor: "oklch(0.24 0.07 155)" }}>
                        {[
                          ...
                          <th
                            key={h}
                            className="px-4 py-3 text-left text-xs font-semibold tracking-wider uppercase text-white"
                          >
                            {h}
                          </th>
                        ))}
                      ...
                      {filteredQuiz.length === 0 ? (
                        ...
                        filteredQuiz.map((q, i) => (
                          <tr
                            ...
                            style={{
                              backgroundColor:
                                i % 2 === 0 ? "white" : "oklch(0.97 0.015 90)",
                            }}
                          >
                            <td
                              className="px-4 py-3 text-sm font-medium"
                              style={{ color: "oklch(0.22 0.005 65)" }}
                            >
                              {q.name}
                            </td>
                            <td
                            ...
                            <td className="px-4 py-3">
                              <span
                                ...
                                style={{
                                  backgroundColor: q.tier.includes(
                                    "Significant",
                                  )
                                    ? "oklch(0.24 0.07 155 / 0.10)"
                                    : q.tier.includes("Moderate")
                                      ? "oklch(0.60 0.12 42 / 0.10)"
                                      : "oklch(0.55 0.06 155 / 0.10)",
                                  color: q.tier.includes("Significant")
                                    ? "oklch(0.24 0.07 155)"
                                    : q.tier.includes("Moderate")
                                      ? "oklch(0.60 0.12 42)"
                                      : "oklch(0.55 0.06 155)",
